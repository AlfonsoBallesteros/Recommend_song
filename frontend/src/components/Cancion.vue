...
<div>
    <div id="overlay">
        <img class="big-image" src="https://images.unsplash.com/photo-1483412033650-1015ddeb83d1?ixlib=rb-0.3.5&q=85&fm=jpg&crop=entropy&cs=srgb&s=d2e8e353d0865401d5d29fb0bb5df48b"/>
    </div>
    <header>
        <div id="song-info">
    ...
    <div id="content">
        ...
        <br>
       <div class="row">
           <div class="col-md-12"><h1>Canciones que te gustarían</h1></div>
           <div class="gallery_product col-md-3 filter hdpe">
                <a href="cancion.html"><img src="http://fakeimg.pl/365x365/" class="img-fluid"></a>
                <h4 class="texto-encima">Canción: Todo de cabeza  Autor: Kaleth Morales </h4>
            </div>
